    ...
    async eliminarProducto(sku, cantidad) {
        return new Promise((resolve, reject) => {
            ...
            if (cantidad < productoEncontrado.cantidad) {
                ...
                this.precioTotal = this.precioTotal - (productoEncontrado.precio * cantidad);
                resolve(`Se eliminaron ${cantidad} unidades del producto con SKU ${sku}.`);
            } else {
                const indexProducto = this.productos.findIndex(producto => producto.sku === sku);
                this.precioTotal -= productoEncontrado.cantidad * productoEncontrado.precio;
                
                this.productos.splice(indexProducto, 1);
                resolve(`Se eliminó el producto con SKU ${sku} del carrito.`);
            }
        });
    }
}
...
carrito.agregarProducto("saraza", 4);
const respuesta = carrito.eliminarProducto("WE328NJ", 3);
console.log(carrito.precioTotal)
